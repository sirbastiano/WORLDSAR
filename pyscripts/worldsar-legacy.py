...
def pipeline_sentinel(
    ...
    # TODO: rectivate the subaperture processor after veryfing everything works fine.
    ...
    op.do_subaps(safe_path=product_path, dim_path=op.prod_path, n_decompositions=[2], byte_order=1, VERBOSE=False)
    op.polarimetric_decomposition(decomposition="Freeman-Durden Decomposition", window_size=5)
